...
tmpclass.initialize_model(aperture_plane_resolution = 1.0,center_on_brightest_pix=True,
...
tmpfitclass.plot_fit_results(savefigname='m2test.png')
tmpfitclass.save_results('m2testresults.json')
