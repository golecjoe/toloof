...
tmpfitclass = fit_beam_with_pointing_offsets(tmpclass,n_jobs=4)
tmpfitclass.run_fitter()
tmpfitclass.plot_fit_results(savefigname='new_offset_image_BP.png')
tmpfitclass.save_results('new_offset_results_BP.json')
